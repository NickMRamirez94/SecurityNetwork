...
def AddSecurityNetwork():
    print("-------------------Add network---------------------")
    print("This will expand your netwrok into a new city")
    print("Information needed to perform this operation")
    print("will be prompted")
    print("-----------------------------------------------------")

    print("Please supply the name of the network location and the ID")
    ...
    if (len(result) == 1)
        print("It appears the the network ID you are adding alread exist")
        print("Please check you ID number and reattempt if necessary")
    else
        print("OK, adding this network to the systme")

        ADD_NET = "INSERT security_netwrok VALUES ("
...
print
print
    print("Please enter in the Employee ID number")
    ...
    if (len(result) == 0)
        ...
        print("user" + EMP_ID + "found... deleting from databse")
